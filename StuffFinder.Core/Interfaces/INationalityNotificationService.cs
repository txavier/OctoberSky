...
namespace StuffFinder.Core.Interfaces
{
    ...
    {
        System.Collections.Generic.IEnumerable<StuffFinder.Core.Models.nationalityNotification> Search(StuffFinder.Core.Objects.SearchCriteria searchCriteria, bool lazyLoadingEnabled = true, bool proxyCreationEnabled = true);
