...
namespace StuffFinder.Core.Interfaces
{
    public interface INationalityService : AutoClutch.Auto.Service.Interfaces.IService<StuffFinder.Core.Models.nationality>
    {
        ...
        System.Collections.Generic.IEnumerable<StuffFinder.Core.Models.nationality> Search(StuffFinder.Core.Objects.SearchCriteria searchCriteria, bool lazyLoadingEnabled = true, bool proxyCreationEnabled = true);
